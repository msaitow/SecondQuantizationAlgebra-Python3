...
#sigma = sqa.tensor('S2_i', [i, j, a, b], [])
#sqa.convertF90_1(sigma, result, True, 'sig', 'V', 'T')
    ...
    for tag_h2_q in [tag_active, tag_virtual]:
        for tag_h2_r in [tag_active, tag_virtual]:
            for tag_h2_s in [tag_active, tag_virtual]: 
                ...
                term1 = sqa.term( 0.5, ["T0"], E_ijab + [V_pqrs] + E_pqrs)
...
sqa.factorize(sigma, result, 'sigma_oovv_G', True, 'sig', 'V2', 'T2', 'int')
