...
for tag_h1_p in [tag_active, tag_virtual]:
    for tag_h1_q in [tag_active, tag_virtual]:
        ...
        term1 = sqa.term( 1.0, [], E_ijka + [h_pq] + E_pq + T_bnml + E_bnml)
        ...
        term2 = sqa.term(-1.0, [], E_ijka + T_bnml + E_bnml + [h_pq] + E_pq)
    ...
    for tag_h2_q in [tag_active, tag_virtual]:
        for tag_h2_r in [tag_active, tag_virtual]:
            for tag_h2_s in [tag_active, tag_virtual]: 
                ...
                term1 = sqa.term( 0.5, [], E_ijka + [V_pqrs] + E_pqrs +  T_bnml  + E_bnml)
                term2 = sqa.term(-0.5, [], E_ijka +  T_bnml  + E_bnml + [V_pqrs] + E_pqrs)
...
# Overlap part ....
term3 = sqa.term( 1.0, ["Ecas"], E_ijka + T_bnml + E_bnml)
...
sqa.factorize(sigma, result, 'sigma_ooov_ooov', True, 'sig', 'V2', 'T2', 'int')
